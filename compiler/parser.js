...
function peg$parse(input, options) {
  ...
  function peg$f0(elements) {    return elements;  }
  function peg$f1(name, props, children) {
      return {
        type: name,
        props: props || {},
        children: children || []
  ...
  function peg$f2(elements) {    return elements;  }
  function peg$f3(pairs) {
      return Object.fromEntries([pairs[0], ...pairs[1].map(p => p[3])]);
  }
