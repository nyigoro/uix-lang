...
function peg$parse(input, options) {
  ...
  const peg$e3 = peg$literalExpectation("for", false);
  const peg$e4 = peg$literalExpectation("in", false);
  const peg$e5 = peg$literalExpectation("{", false);
  const peg$e6 = peg$literalExpectation("}", false);
  const peg$e7 = peg$literalExpectation(",", false);
  const peg$e8 = peg$literalExpectation(":", false);
  const peg$e9 = peg$literalExpectation("bind", false);
  ...
  function peg$f2(name, props, children) {
      return {
        type: name,
        props: props ?? {},
        children: children ?? []
  ...
  function peg$f4(item, list, children) {
      return {
        type: "For",
        item,
        list,
  ...
  function peg$f12(first, rest) {    // Redefined to explicitly match identifiers separated by dots
         let result = first;
